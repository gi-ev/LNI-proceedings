...
\setlength{\papervoffset}{-26.6cm}
\else
\setlength{\paperhoffset}{0cm}
\setlength{\papervoffset}{-29.7cm}
\fi
%copied from lni.cls
\ifcrop
   \RequirePackage[
...
\newcommandtwoopt{\addpaper}[5][DEF][DEF]{%
    ...
    \AddToShipoutPictureBG*{\AtPageUpperLeft{%
        ...
        \put(\LenToUnit{\the\paperhoffset},\LenToUnit{\the\papervoffset}){\includegraphics[page=1, viewport=0 0 21cm 23.628cm, clip]{papers/#3/paper.pdf}}}
    }
	\phantomsection
