...
def lookup_workshop(workshop_id):
    workshops = {
        "B1": "Musik trifft Informatik",
        "B2": "7,5. HDI-Workshop des GI-Fachbereichs Informatik und Ausbildung / Didaktik der Informatik",
        "B3": "Teilhabe an der allgemeinen Kommunikation",
        "B4": "CDG – Competence Developing Games",
        "B5": "HDP – Hardware Defined Programming",
        "B6": "Blended Museum: Neue Formen der medialen Kulturvermittlung",
        "B7": "MOC 2017 – 9. Workshop zur Deklarativen Modellierung und effizienten Optimierung komplexer Probleme",
        "B8": "Partizipatives Entwerfen soziotechnischer Systeme",
        "B9": "Keys4All – Herausforderungen von Schlüsselverzeichnissen für die E-Mail-Verschlüsselung",
        "B10": "ZuGPM 2017 – Workshop zum Stand, den Herausforderungen und Impulsen des Geschäftsprozessmanagements",
        "B11": "SENSYBLE – Smart Systems for Better Living Environments",
        "B12": "2nd GI/ACM Industry4.0 Security Standardisation Workshop on Industrial Automation and Control Systems (IACS)",
        "B13": "RuT2017 – Recht und Technik: Datenschutz im Diskurs",
        "B14": "Modellierung4DH -- Modellierungsfragen in den Digitalen Geisteswissenschaften",
        "B15": "VO-SoTeDIT – Value Oriented Sociotechnical Design of the Internet of Things",
        "B16": "IT-Rettung 2017: IT-Unterstützung in Emergency Management & Response",
        "B17": "FDM2017 – Digitale Prozesse und Informationssysteme im Forschungsdatenmanagement",
        "B18": "Der Arbeitsplatz der Zukunft 2.0",
        "B19": "ASE – 15. Workshop Automotive Software Engineering",
        "B20": "KASDL -- Kontext-adaptive Software in Digitalen Lebenswelten",
        "B21": "ITG-SIM – IT-Governance und Strategisches Informationsmanagement",
        "B22": "CAAI4Games – Creating Advanced AI For Games",
        "B23": "Hochschule 2027",
        "B24": "BDSDST 2017 – 3rd International Workshop on Big Data, Smart Data and Semantic Technologies",
        "B25": "Digitaler Journalismus (in postfaktischen Zeiten)",
        "B26": "LEDSPLaY17",
        "B27": "UINW 2017 – 5. Workshop Umweltinformatik zwischen Nachhaltigkeit und Wandel",
        "B28": "Unternehmensarchitektur in Forschung und Praxis",
        "B29": "Deep Learning in heterogenen Datenbeständen",
        "B30": "OSvCS FT – Digitalen Veränderungen auf der Spur: Open vs. Closed Source Forensic Tools",
        "B31": "Migration und Medien",
        "B32": "CSCOG – Computer Science & Cognition",
        "B33": "Qualitative und quantitative Ansätze in der UsabilityForschung",
        "C1": "Doktorandensymposium",
        "E1": "Studierendenkonferenz Informatik 2017 (SKILL 2017)",
        "F1": "Tutorien",
    }
