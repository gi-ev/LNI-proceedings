...
\newcommandtwoopt{\addpaper}[5][DEF][DEF]{%
    ...
    \AddToShipoutPictureBG*{\AtPageUpperLeft{%
        ...
        \put(\LenToUnit{\the\paperhoffset},\LenToUnit{\the\papervoffsetFirstPage}){\includegraphics[page=1, trim=0 5cm 21cm 23.628cm, clip]{papers/#3/paper.pdf}}}
    }
    \outputlicenseanddoi
	\phantomsection
    ...
    \ifthenelse{\the\pdflastximagepages>1}{
        ...
        \whiledo{\value{curpage}<\the\pdflastximagepages}{
            \stepcounter{curpage}
            \AddToShipoutPictureBG*{\AtPageUpperLeft{%
              \put(\LenToUnit{\the\paperhoffset},\LenToUnit{\the\papervoffset}){\includegraphics[page=\the\value{curpage}, trim=0 0 21cm 23.628cm, clip]{papers/#3/paper.pdf}}}
            }
            \null
            \newpage
        }
...
\newcommandtwoopt{\addpaperWRONGLAYOUT}[5][DEF][DEF]{%
	...
	\AddToShipoutPictureBG*{\AtPageUpperLeft{%
			%When using 23.649cm, there might be the toprule shown - try different zoom levels and Acrobat. With SumatraPDF, the issue is not visible all times
			\put(\LenToUnit{5pt},\LenToUnit{-779pt}){\includegraphics[page=1, trim=0 0 21cm 23.628cm, clip]{#3/paper.pdf}}}
	}
	\outputlicenseanddoi
	\phantomsection
	\suppress\cite{#3}\endsuppress
	...
	\ifthenelse{\the\pdflastximagepages>1}{
		...
		\whiledo{\value{curpage}<\the\pdflastximagepages}{
			...
			\AddToShipoutPictureBG*{\AtPageUpperLeft{%
					...
					\put(\LenToUnit{5pt},\LenToUnit{-772pt}){\includegraphics[page=\the\value{curpage}, trim={0 458752sp 21cm 44517417sp}, clip]{#3/paper.pdf}}}
			}
			\null
			\newpage
		}
