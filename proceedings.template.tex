...
%By default show no page numbers for parts in TOC, but for the author index
\newif\iftocpartshowpage
\tocpartshowpagefalse % default: suppress page number
\newcommand*{\maybePrintPartPageNumber}[1]{%
  \iftocpartshowpage
    \global\tocpartshowpagefalse
    #1%
  \else
    % print nothing
  \fi
...
\DeclareTOCStyleEntry[%
  ...
  pagenumberformat={\maybePrintPartPageNumber}
]{part}{part}
...
%% content should start on page 1
\newcounter{firstcontentpage}
\setcounter{firstcontentpage}{\value{page}} % store current page number
\newwrite\offsetfile
\openout\offsetfile=offset.txt
\write\offsetfile{\arabic{firstcontentpage}}
\setcounter{page}{1}
...
\phantomsection
\addtocontents{toc}{\protect\global\protect\tocpartshowpagetrue}
